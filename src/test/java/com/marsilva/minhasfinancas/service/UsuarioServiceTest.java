...
import com.marsilva.minhasfinancas.service.impl.UsuarioServiceImpl;
...
public class UsuarioServiceTest {
	...
	public void deveLancarErroQuandoNaoEncontrarUsuarioCadastradoComEmailInformado() {
		...
		// acao
		Throwable exception = Assertions.catchThrowable(() -> service.autenticar("email@ema.com", "senha"));
	...
	public void deveLancarErroQuandoSenhaNaoBater() {
		...
		//acao
		Throwable exception = Assertions.catchThrowable(() -> service.autenticar("emal@email.com", "123"));
